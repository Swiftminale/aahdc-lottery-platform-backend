...
module.exports = (sequelize, DataTypes) => {
  const Unit = sequelize.define('Unit', {
    ...
    totalBuildingGrossArea: { // For validation purposes per building
      type: DataTypes.FLOAT,
      allowNull: false,
    },
    owner: { // To store 'AAHDC' or 'Developer' after allocation
      type: DataTypes.STRING,
      allowNull: true,
    },
    allocated: { // Flag to indicate if unit has been allocated
